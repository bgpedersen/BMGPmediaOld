				...
				<div class="col-md-4 col-xs-12">
					<div class="project_content_left">
						...
						<ul>
							...
							<li>- Specializing in AngularJS framework and creating solid system structures</li>
							<li>- Data-mapping, modules and functions</li>
							<li>- Using Loopback framework in a NodeJS enviroment</li>
							<li>- Developing and integrating autogenerated SDK for REST API</li>
							<li>- Creating responsive design</li>
						</ul>
						<p>Code is private</p>
						<a href="http://proreact.dk/wp/interaktiv-borgerguide/" target="_blank"><button type="button" class="btn btn-large btn-info">Explore IBG</button></a>
					</div>
						...
						<div class="project-image">
							...
							<div id="carousel7" class="carousel slide" data-ride="carousel">
								...
								<ol class="carousel-indicators">
									...
									<li data-target="#carousel7" data-slide-to="3"></li>
									<li data-target="#carousel7" data-slide-to="4"></li>
									<li data-target="#carousel7" data-slide-to="5"></li>
									<li data-target="#carousel7" data-slide-to="6"></li>
									<li data-target="#carousel7" data-slide-to="7"></li>
									<li data-target="#carousel7" data-slide-to="8"></li>
								</ol>

								<!-- Wrapper for slides -->
								<div class="carousel-inner" role="listbox">
									<div class="item active">
										<img src="images/proreact/1.png" alt="proreact_1">
									</div>

									<div class="item">
										<img src="images/proreact/2.png" alt="proreact_2">
									</div>

									<div class="item">
										<img src="images/proreact/3.png" alt="proreact_3">
									</div>
									<div class="item">
										<img src="images/proreact/4.png" alt="proreact_2">
									</div>

									<div class="item">
										<img src="images/proreact/5.png" alt="proreact_3">
									</div>
									<div class="item">
										<img src="images/proreact/6.png" alt="proreact_2">
									</div>

									<div class="item">
										<img src="images/proreact/7.png" alt="proreact_3">
									</div>
									<div class="item">
										<img src="images/proreact/8.png" alt="proreact_3">
									</div>
									<div class="item">
										<img src="images/proreact/9.png" alt="proreact_3">
									</div>
